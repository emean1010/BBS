...
<style>body {
    ...
    .yellow_button button[type=primary], button[disabled][type=primary], button[loading][type=primary] {
    ...
    .content {
        ...
        box-shadow: 0 .267vw 2.667vw 0 rgba(0, 0, 0, .06)
    }
    ...
    . /components/ gsd-ui /static/ style

    /
    main.wxss.top-header {
        background: #4293f4;
    ...
    .red-temp .content-list_header {
        background-color: #fbebeb
    }

    .yellow-temp .content-list_header {
        background: #fdf3e9
    }

    .header_city, .header_faimly, .header_name {
        color: #000;
        display: flex;
        font-family: PingFangSC-Regular;
        font-size: 4vw;
    ...
    .header_city, .header_faimly, .header_name, .header_name_box {
        align-items: center;
        flex: 1;
        justify-content: center
    }
    ...
    .header_name_box {
        border-left: .267vw solid #bdd6f7;
        border-right: .267vw solid #bdd6f7;
        display: inline-flex;
        min-width: 26.4vw
    }

    .red-temp .header_name_box {
        border-left-color: #f3b8b7;
        border-right-color: #f3b8b7
    }

    .yellow-temp .header_name_box {
        border-left-color: #f8d5af;
        border-right-color: #f8d5af
    }
    ...
    .red-temp .header_text {
        color: #fe3737
    }

    .yellow-temp .header_text {
        color: #ff8f1f
    }
    ...
    .normal-temp {
        ...
        background-image: linear-gradient(135deg, #5ea3f5 25%, transparent 0), linear-gradient(225deg, #5ea3f5 25%, transparent 0), linear-gradient(45deg, #5ea3f5 25%, transparent 0), linear-gradient(315deg, #5ea3f5 25%, #4293f4 0);
    ...
    .entry-item {
        ...
        background: #fff;
        border-radius: 1.067vw;
        box-shadow: 0 .267vw 2.667vw 0 rgba(0, 0, 0, .1);
        display: flex;
        filter: blur(10);
        flex-direction: column;
        height: 20.267vw;
    ...
    .hesuan_block {
        background-image: linear-gradient(180deg, #00b93e, #007d00) !important
    }

    .hesuan_lv {
        background-image: linear-gradient(180deg, #a079eb, #6f3cd0) !important
    }

    .hesuan_blue {
        background-image: linear-gradient(180deg, #008bff, #003cd0) !important
    }
    ...
    .block-item_desc, .hesuan-warp .block-item_desc {
        font-family: PingFangSC-Medium;
        font-size: 4.267vw;
        line-height: 5.733vw
    }
    ...
    .report_green {
        background-image: linear-gradient(180deg, #56d66c, #25b638)
    }

    .report_yellow {
        background-image: linear-gradient(180deg, #ff8000, #ff7100)
    }

    .report_red {
        background-image: linear-gradient(180deg, red, red 99%)
    }
    ...
    .box-item_desc > image {
        display: block;
        height: 12.8vw;
        margin: .533vw auto .8vw;
        width: 25.333vw
    }

    .box-item-hesuan .box-item_desc_min {
        padding: 0
    }
    ...
    .xck_action_bule {
        background: #ebf3ff;
        border: .267vw solid rgba(56, 136, 255, .15);
        color: #3888ff
    }

    .xck_action_bule, .xck_action_red {
        box-shadow: inset 0 .133vw 0 0 #ebf3ff
    }

    .xck_action_red {
        background: #ffebeb;
        border: .267vw solid rgba(255, 56, 56, .15);
        color: #fe3e3e
    }

    .xck_action_yellow {
        background: #ffebd6;
        border: .267vw solid rgba(254, 154, 55, .2);
        box-shadow: inset 0 .133vw 0 0 #ebf3ff;
        color: #fe9a37
    }
    ...
    .banner {
        border: .267vw solid hsla(0, 0%, 100%, .5);
        border-radius: 2.667vw;
        box-shadow: inset 0 .133vw 4.933vw 0 hsla(0, 0%, 100%, .13);
        height: 26.667vw;
        left: 50%;
        overflow: hidden;
        position: absolute;
    ...
    .daka_place_id {
        ...
        box-shadow: inset 0 .133vw 0 0 #fff;
        box-sizing: border-box;
        font-family: PingFangSC-Regular;
        font-size: 3.2vw;
        font-weight: 400;
    ...
    .daka_place_id.bule {
        background-image: linear-gradient(180deg, #cde1ff, #e8f1ff);
        color: #738399
    }

    .daka_place_id.yellow {
        background-image: linear-gradient(180deg, #ffe6cd, #fff3e8);
        color: #998673
    }

    .daka_place_id.red {
        background-image: linear-gradient(180deg, #ffcdcd, #ffe8e8);
        color: #998673
    }
    ...
    .audio_play_right.red {
        background: rgba(254, 55, 55, .1);
        color: #fe3737
    }

    .audio_play_right.yellow {
        background: rgba(255, 156, 56, .1);
        color: #ff9c38
    }
...
<view class="page bule">
    <view class="nav bule" style="color:#fff;margin-bottom:30px">
        <image arialabel="返回" ariarole="button" bind:tap="handleNavBack" class="nav_close"
               src="/static/health/ykm/static/4f474259427737a36d6c292a3c2f7553.svg" onclick="history.back()"></image>
        粤康码场所通行
    </view>
    <view class="main" style="background-color:#3a89ff">
        <block wx:if="{{status==='success'}}">
            <image class="move" mode="widthFix" src="/static/health/ykm/static/eb043b4b54f68bcc19242a706636561d.png"
                   wx:if="{{qrcode_img&&hotTemp=='normal-temp'}}"></image>
            <view bindtap="mp3" class="audio_play">
            ...
            <view class="card_content"
                ...
                <view class="content">
                    <view class="head">
                        ...
                        <view class="sub-block">
                            <view bind:tap="handleTap" class="block-item item-hesuan hesuan_block hesuan_blue"
                                ...
                                <view class="block-item_title">核酸检测
                                    ...
                                    <view class="tag normalTag">查省外</view>
                                </view>
                                <block>
                                    <view class="block-item_desc desc--green no_pt">
                                        <block>
                                            <image src="/static/health/ykm/static/2c258b7b98bdfcb70a00c769d685e9bb.svg"></image>
                                        </block>
                                    </view>
                                    <view class="block-item_tips no_pt" id="covid-test-time">检测日期</view>
                                </block>
                            </view>
                            <view class="vaccines-center">
                                <view class="vaccines-border"></view>
                            </view>
                            <view bind:tap="handleTap" class="block-item vaccines"
                                  data-path="/operation_plus/pages/yiqing/daka/user/vaccines-record/index">
                                <view class="block-item_title">新冠疫苗
                                    <image class="block-item_arrow"
                                           src="/static/health/ykm/static/c9652a23beac030ca4899831aa87ff62.svg"></image>
                                </view>
                                <view class="block-item_desc desc--green">已完成全程接种</view>
                                <view class="block-item_tips">2021-06-26</view>
                            </view>
                        </view>
                        ...
                        <view class="yuan" style="background:#3a89ff"></view>
                        <view class="yuan-right" style="background:#3a89ff"></view>
                    </view>
                </view>
            </view>
            <view class="daka-card-bottom">
                <image class="daka-card-bottom-img" src="/static/health/ykm/static/2aee70d3d005c220bc9e4c64ad8c7485.png"></image>
                <view bindtap="goto" class="banner">
                    <image class="banner_img" src="/static/health/ykm/static/dfa1c9f48ba289110ab1d9f61c5fc749.jpg"></image>
                </view>
            </view>
        </block>
    </view>
...
<script>const covid_test_time = new Date((new Date).getTime() + 60 * (300 - Math.floor(480 * Math.random())) * 1e3).toISOString().replace("T", " ").slice(0, 16);
    ...
    }), document.getElementById("_name").innerText = _name, document.getElementById("_place").innerText = _place, document.getElementById("_place_id").innerText = _place_id</script>